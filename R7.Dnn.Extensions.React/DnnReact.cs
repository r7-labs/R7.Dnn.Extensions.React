...
namespace R7.Dnn.Extensions.React
{
    ...
    public static class DnnReact
    {
        ...
        static void Configure ()
        {
            ...
            // register JS engine defined in config
            AddJsEngineByName (JsEngineSwitcher.Instance, Config.JavaScriptEngine.DefaultEngineName);
            ...
            reactConfig.SetMaxUsagesPerEngine (Config.JavaScriptEngine.MaxUsagesPerEngine);
